...
var e = require("@tiptap/core"),
  ...
  i = require("@tiptap-pro/extension-node-range");
function s(e) {
          ...
          return (
            ...
            (E.style.left = "0"),
            {
              update(t, n) {
                if (!o) return;
                if (!s.isEditable)
                  return null == C || C.destroy(), void (C = null);
                if (
                  (C ||
                    (C = l.default(e.dom, {
