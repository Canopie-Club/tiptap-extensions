...
import type { SlashMenuItem } from "../contants/menuItems";
...
<style lang="scss">
.slash-menu {
    @apply absolute z-10 min-w-[280px] overflow-scroll rounded-md bg-white shadow-lg;
    max-height: 340px;

    /* @apply max-h-80; */

    .slash-menu-item {
        @apply flex cursor-pointer items-center transition-colors duration-200;
        @apply p-3;
